...
final class HttpRequestLine {
    ...
    public char[] method;   //请求方法
    public int methodEnd;   //请求方法字符结束下标
    public char[] uri;      //请求uri
    public int uriEnd;      //请求uri字符结束下标
    public char[] protocol; //请求协议
    public int protocolEnd; //请求协议字符结束下标
